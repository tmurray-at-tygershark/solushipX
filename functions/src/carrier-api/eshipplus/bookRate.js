...
async function processBookingRequest(data) {
    ...
    try {
        ...
        // Process ALL shipping documents normally
        ...
        // Note: eShipPlus BOL generation removed - using Generic BOL from bookRateUniversal.js instead
        // This ensures consistency with QuickShip.jsx which only generates Generic BOL
        logger.info('📋 eShipPlus BOL generation skipped - Generic BOL will be generated by bookRateUniversal.js');
